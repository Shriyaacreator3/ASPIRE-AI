...
export function CloudStationModel(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('models/cloud_station/scene.gltf')
...
useGLTF.preload('models/cloud_station/scene.gltf')
